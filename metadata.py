...
def extract_vars_from_md_with_retry(md_content, max_retries=5):
    def call_openai():
        system_prompt = """
            ...
            4. **Projection:**
            - The *projection* or map reference, typically formatted as something like CRS "US-SPC27-EXACT / Texas Central 4203"  or similar terms but the "exact text" now the surrounding text.
            -  US State Plane 1927
            ...
            **Instruction for JSON output formatting:**
            ...
            "Projection":["US State Plane 1927","Reference: US State Plane 1927"],
